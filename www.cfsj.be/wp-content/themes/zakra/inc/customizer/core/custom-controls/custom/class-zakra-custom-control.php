 ...
 * Class Zakra_Custom_Control
 */
class Zakra_Custom_Control extends Zakra_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<# if ( data.info ) { #>
		<div class="zakra-custom-info">
			{{{ data.info }}}
		</div>
		<# } #>

		<# if ( data.links ) { #>
		<ul class="zakra-custom-links">
