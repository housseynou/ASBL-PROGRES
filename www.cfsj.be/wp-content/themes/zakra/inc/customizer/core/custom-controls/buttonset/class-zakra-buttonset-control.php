 ...
 *
 * Class Zakra_Buttonset_Control
 */
class Zakra_Buttonset_Control extends Zakra_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="buttonset">
			...
			<div class="buttonset-inner">
				...
				<label for="{{ data.id }}{{ key }}" class="zakra-buttonset">
					{{{ data.choices[ key ] }}}
				</label>
			</div>
			<# } #>
