 ...
 *
 * Class Zakra_Dropdown_Categories_Control
 *
 * @package    ThemeGrill
 * @subpackage Zakra
 * @since      Zakra 3.0.0
 ...
 * Class Zakra_Dropdown_Categories_Control
 */
class Zakra_Dropdown_Categories_Control extends Zakra_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'zakra-dropdown-categories';
