...
zakraGenerateDimensionCSS( 'zakra_header_button_padding', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a', 'padding' );
zakraGenerateCSS( 'zakra_header_button_text_color', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a', 'color' );
zakraGenerateCSS( 'zakra_header_button_text_hover_color', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a:hover', 'color' );
zakraGenerateCSS( 'zakra_header_button_bg_color', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a', 'background-color' );
zakraGenerateCSS( 'zakra_header_button_bg_hover_color', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a:hover', 'background-color' );
...
zakraGenerateCSS( 'zakra_header_button_roundness', '.main-navigation.tg-primary-menu > div ul li.tg-header-button-wrap a', 'border-radius', 'px' );
