 ...
 *
 * Class Zakra_Typography_Control
 *
 * @package    ThemeGrill
 * @subpackage Zakra
 * @since      Zakra 3.0.0
 ...
 * Class Zakra_Typography_Control
 */
class Zakra_Typography_Control extends Zakra_Customize_Base_Additional_Control {
	...
	public function enqueue() {
		...
		$google_font_subsets = Zakra_Fonts::get_google_font_subsets();
		$localize_scripts    = array(
			'standardfontslabel' => esc_html__( 'Standard Fonts', 'zakra' ),
			'googlefontslabel'   => esc_html__( 'Google Fonts', 'zakra' ),
		...
		if ( ! empty( $custom_fonts ) ) {
			$localize_scripts['customfontslabel'] = esc_html__( 'Custom Fonts', 'zakra' );
		...
		wp_localize_script(
			...
			'ZakraCustomizerControlTypography',
			$localize_scripts
		);
		...
		wp_localize_script(
			'zakra-customize-controls',
			'ZakraCustomizerControlTypographySubsets',
			$google_font_subsets
		);
	...
	protected function format_variants_array( $variants ) {
		...
		$font_variants  = Zakra_Fonts::get_font_variants();
	...
	public function get_google_fonts() {
		...
		$font_variants         = Zakra_Fonts::get_font_variants();
		$foogle_fonts__subsets = Zakra_Fonts::get_google_font_subsets();
	...
	public function get_custom_fonts() {
		...
		$custom_fonts       = Zakra_Fonts::get_custom_fonts();
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="font-family">
				<span class="customize-control-title"><?php esc_html_e( 'Family', 'zakra' ); ?></span>
				<div class="zakra-field-content">
					<select {{{ data.inputAttrs }}} id="zakra-font-family-{{{ data.id || data.name }}}"></select>
				</div>
			</div>

			<# if ( data.default['font-weight'] ) { #>
			<div class="font-weight">
				<span class="customize-control-title"><?php esc_html_e( 'Weight', 'zakra' ); ?></span>
				<div class="zakra-field-content">
					<select {{{ data.inputAttrs }}} id="zakra-font-weight-{{{ data.id || data.name }}}"></select>
				</div>
			</div>
			<# } #>
			...
			<div class="subsets">
				<span class="customize-control-title"><?php esc_html_e( 'Subset(s)', 'zakra' ); ?></span>
				<div class="zakra-field-content">
					<select {{{ data.inputAttrs }}} id="zakra-subsets-{{{ data.id || data.name }}}" multiple>
			...
			<div class="font-size">
				<span class="customize-control-title"><?php esc_html_e( 'Size', 'zakra' ); ?></span>
				...
				<div class="desktop control-wrap active">
					<input type="text"
					       id="zakra-font-size-desktop-{{{ data.id || data.name }}}"
					       data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
					       id="zakra-font-size-tablet-{{{ data.id || data.name }}}"
					       data-device="tablet"
							<# if ( data.value['font-size'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
					       id="zakra-font-size-mobile-{{{ data.id || data.name }}}"
					       data-device="mobile"
							<# if ( data.value['font-size'] ) { #>
			...
			<div class="line-height">
				<span class="customize-control-title"><?php esc_html_e( 'Line Height', 'zakra' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
					       id="zakra-line-height-desktop-{{{ data.id || data.name }}}"
					       data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
					       id="zakra-line-height-tablet-{{{ data.id || data.name }}}"
					       data-device="tablet"
							<# if ( data.value['line-height'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
					       id="zakra-line-height-mobile-{{{ data.id || data.name }}}"
					       data-device="mobile"
							<# if ( data.value['line-height'] ) { #>
			...
			<div class="letter-spacing">
				<span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'zakra' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
					       id="zakra-letter-spacing-desktop-{{{ data.id || data.name }}}"
					       data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
					       id="zakra-letter-spacing-tablet-{{{ data.id || data.name }}}"
					       data-device="tablet"
							<# if ( data.value['letter-spacing'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
					       id="zakra-letter-spacing-mobile-{{{ data.id || data.name }}}"
					       data-device="mobile"
							<# if ( data.value['letter-spacing'] ) { #>
			...
			<div class="font-style">
				<span class="customize-control-title"><?php esc_html_e( 'Style', 'zakra' ); ?></span>
				<div class="zakra-field-content">
					<select {{{ data.inputAttrs }}} id="zakra-font-style-{{{ data.id || data.name }}}">
						<option value="normal"
						<# if ( 'normal' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Normal', 'zakra' ); ?></option>
						<option value="italic"
						<# if ( 'italic' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Italic', 'zakra' ); ?></option>
						<option value="oblique"
						<# if ( 'oblique' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Oblique', 'zakra' ); ?></option>
						<option value="initial"
						<# if ( 'initial' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Initial', 'zakra' ); ?></option>
						<option value="inherit"
						<# if ( 'inherit' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Inherit', 'zakra' ); ?></option>
					</select>
				</div>
			</div>
			<# } #>
			...
			<div class="text-transform">
				<span class="customize-control-title"><?php esc_html_e( 'Transform', 'zakra' ); ?></span>
				<div class="zakra-field-content">
					<select {{{ data.inputAttrs }}} id="zakra-text-transform-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'zakra' ); ?></option>
						<option value="capitalize"
						<# if ( 'capitalize' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Capitalize', 'zakra' ); ?></option>
						<option value="uppercase"
						<# if ( 'uppercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Uppercase', 'zakra' ); ?></option>
						<option value="lowercase"
						<# if ( 'lowercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Lowercase', 'zakra' ); ?></option>
						<option value="initial"
			...
			<div class="text-decoration">
				<span class="customize-control-title"><?php esc_html_e( 'Decoration', 'zakra' ); ?></span>
				<div class="zakra-field-content">
					<select {{{ data.inputAttrs }}} id="zakra-text-decoration-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'zakra' ); ?></option>
						<option value="underline"
						<# if ( 'underline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Underline', 'zakra' ); ?></option>
						<option value="overline"
						<# if ( 'overline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Overline', 'zakra' ); ?></option>
						<option value="line-through"
						<# if ( 'line-through' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Line Through', 'zakra' ); ?></option>
						<option value="initial"
